                ...
                <table class="tableform">
                    <tbody>
                        ...
                        <tr>
                            <td style="width: 150px;"></td>
                                <div class="notice" id="infoText">
                                    - Cập nhật chính xác địa chỉ email và số điện thoại để bảo vệ tài khoản<br><br>
                                    - Chỉ có thể tự cập nhật thông tin một làn duy nhất <br> <br>
                                    - Liên hệ BQT nếu có nhu cầu thay đổi thông tin cá nhân <br> <br>
                                </div>
                        </tr>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <input data-val="true" data-val-regex="Sai định dạng Số điện thoại" data-val-regex-pattern="^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$" data-val-required="Chưa nhập số điện thoại" id="phone" name="phone" style="width: 190px;" type="text" value="" />
                            </td>
