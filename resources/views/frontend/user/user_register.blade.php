            ...
            <table class="tableform">
                <tbody>
                    ...
                    <tr>
                        <td></td>
                        <td>
                            <input type="submit" id="submitbtn" alt="Xác nhận" src="{{asset('images/confirm.gif')}}" tppabs="">
                            <input type="reset" id="resetbtn" alt="Nhập lại" src="{{asset('images/retry.gif')}}" tppabs="" onclick="mainForm.reset();
                                        return false;">
                        </td>
                        <td></td>
                    </tr>
