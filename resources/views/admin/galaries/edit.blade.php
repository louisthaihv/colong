...
@section('content')
    ...
    @include('admin.error-message')
        <div class="col-md-12">
            <form action="{{ route('admin.galaries.update', $galary->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <table class="table">
                    ...
                    <tr>
                        <td>TIÊU ĐÊ: </td>
                        <td>
                            <input type="text" name = "title" value="{{ $galary->title }}" required>
                        </td>
                    </tr>
                    <tr>
                        <td>ẢNH: </td>
                        <td>
                            ...
                            <img src="{{ asset($galary->image_url) }}" id="image"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
