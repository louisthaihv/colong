...
<div class="row">
<div class="col-md-12">
    <form action="{{ route('admin.clans.store') }}" method="POST" enctype="multipart/form-data">
    <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
        ...
        <div class="form-group col-sm-4 col-md-8">
            ...
            <br />
            <img src="" class="img-thumbnail" width="500" height="500" id="back_ground_image_url">
        </div>
        <div class="form-group col-sm-4 col-md-8">
            <label for="title_url">ẢNH NHỎ: </label>
            <input type="file" class = "form-controll" name = "title_url" />
            <br />
            <img src="" class="img-thumbnail" width="304" height="236" id="title_url">
        </div>
        <div class="form-group col-sm-4 col-md-8">
            <label for="slide_url">ẢNH Slide: </label>
            <input type="file" class = "form-controll" name = "slide_url" />
            <br />
            <img src="" class="img-thumbnail" width="304" height="236" id="slide_url">
        </div>
        <div class="form-group col-sm-4 col-md-8">
            <a class="btn btn-success" href="{{route('admin.clans.index')}}">Quay lại</a>
